...
# 19 个直连源 + 4 个配置中心源（与 update.yml 保持一致）
SOURCES = [
    "索尼", "金鹰", "红牛", "猫眼", "樱花", "非凡", "光速", "无尽", "速播", "极速",
    "火狐", "西瓜", "优酷", "百度", "豆瓣", "暴风", "星球", "量子", "茅台",
    "最大", "爱奇艺", "魔都", "360", "旺旺", "如意", "率率",
]
CATS = ["tv", "anime", "variety"]   # 仅剧集类需要分集；movie 一般为整片，跳过省时

BUDGET = 6000   # 每个 run 最多采的页数（≈5h @ 3s/页，留余量防 6h job 超时）
