...
COLLECTORS = {
    "cc0cd": {
        ...
        "direct_sources": {
            ...
            # 最大资源：122320 条大站，分类干净（电影/电视剧/综艺/动漫），国内播放域 179ms
            "最大": "https://api.zuidapi.com/api.php/provide/vod/",
            # 爱奇艺资源：66630 条，含里番动漫（已被 COLLECT_BLOCK_TYPES 过滤），国内播放域 177ms
...
# 播放线路显示名映射：把 MacCMS 线路代码/源站 play_from 转成中文，
# 让网页播放器的「播放源」按钮显示“极速/暴风/爱奇艺”等人能看懂的名字。
# key 大小写敏感；未命中时保持原值。
SOURCE_LABELS = {
    # 已经是中文的保持原样
    "如意": "如意", "文采": "文采", "暴风": "暴风", "最大": "最大",
    "极速": "极速", "猫眼": "猫眼", "西瓜": "西瓜", "量子": "量子",
    "非凡": "非凡",
    # 兜底采集器名
    "cc0cd": "聚合",
    # 配置中心源
    ...
    "ruyi": "如意", "rym3u8": "如意",
    "snm3u8": "索尼",
    "subm3u8": "速播", "subyun": "速播",
    "tym3u8": "天意",
    "ukm3u8": "UK资源", "ukyun": "UK资源",
    "wjm3u8": "无尽",
    "wsym3u8": "文森",
    "xigua": "西瓜", "xiguam3u8": "西瓜",
    "yhm3u8": "樱花",
    "youku": "优酷",
    "zuidam3u8": "最大",
    ...
    "dytt": "电影天堂",
    "wjyun": "无尽",
    # 新浪资源：api.xinlangapi.com（2026-09-24 补，3.3 万行此前兜底成「线路N」）
    "xlm3u8": "新浪", "xlyun": "新浪",
}
